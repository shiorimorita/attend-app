...
<main class="attendance__status">
    ...
    <p class="attendance__status-time" id="current-time">{{now()->format('H:i')}}</p>
    ...
    <form action="/attendance/break-out" method="post" class="attendance__status-form">
        ...
        <button type="submit" id="break-out-btn" class="attendance__status-change-button attendance__status-change-button--break">休憩戻</button>
    </form>
    ...
    <div class="attendance__status-change-buttons">
        <form action="/attendance/clock-out" method="post">
            ...
            <button type="submit" id="check-out-btn" class="attendance__status-change-button common-btn">退勤</button>
        </form>
        <form action="/attendance/break-in" method="post">
            @csrf
            <input type="hidden" id="break-in-time" name="break_in_time">
            <button type="submit" id="break-in-btn" class="attendance__status-change-button attendance__status-change-button--break">休憩入</button>
        </form>
    </div>
    @else
