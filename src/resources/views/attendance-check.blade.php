...
<main class="attendance__detail">
    ...
    <form action="{{ $actionUrl ?? ''}}" class="attendance__form" method="post">
        ...
        <div class="attendance__form-inner">
            ...
            <div class="attendance__form-group attendance__form-group--input @if($readonly) attendance__form-group--remark-readonly @endif">
                ...
                <div class="attendance__form-value">
                    ...
                    <span class="attendance__input-separator @if($readonly) attendance__input-separator--readonly @endif">～</span>
            ...
            <div class="attendance__form-group attendance__form-group--input @if($readonly) attendance__form-group--remark-readonly @endif">
                ...
                <div class="attendance__form-value">
                    @if($readonly)
                    <p class="attendance__remark-textarea--readonly">
                        {{ old('description', $descriptionDefault ?? (optional($correction)->description ?? optional($attendance)->description ?? '')) }}
                    </p>
                    <input type="hidden" name="description" value="{{ old('description', $descriptionDefault ?? (optional($correction)->description ?? optional($attendance)->description ?? '')) }}">
                    @else
                    <textarea class="attendance__remark-textarea" name="description" id="description">{{ old('description', $descriptionDefault ?? (optional($correction)->description ?? optional($attendance)->description ?? '')) }}</textarea>
                    @endif
                </div>
        ...
        @else
        <button type="submit" class="attendance__form-submit--staff attendance__form-submit common-btn">
            修正
        </button>
        @endif
        {{-- admin --}}
